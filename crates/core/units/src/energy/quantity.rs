...
macro_rules! define_energies {
    (
        ...
        pub struct EnergyQuantityIdless {
            value: f64,
            unit: EnergyUnit,
        }

        impl EnergyQuantityIdless {
        ...
        impl EnergyQuantity {
            ...
            pub fn get_energy_quantity_idless(&self) -> EnergyQuantityIdless {
                EnergyQuantityIdless {
