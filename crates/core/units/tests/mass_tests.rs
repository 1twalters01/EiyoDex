...
fn test_mass_as_fn() {
    ...
    let mass_g = MassQuantity::from_g(value);
    let mass_mg = MassQuantity::from_mg(value);
    let mass_kg = MassQuantity::from_kg(value);
    let mass_ug = MassQuantity::from_ug(value);
    let mass_oz = MassQuantity::from_oz(value);
...
fn test_mass_to_unit() {
    ...
    let mass_g = MassQuantity::from_g(value);
    let mass_oz = MassQuantity::from_oz(new_value);
...
fn test_mass_is_zero() {
    let zero_mass = MassQuantity::from_g(0f64);
    let mass = MassQuantity::from_g(5.5);
...
fn test_mass_is_negative() {
    let negative_mass = MassQuantity::from_g(-5.5);
    let mass = MassQuantity::from_g(5.5);
...
fn test_mass_get_value() {
    let mass = MassQuantity::new(6.882, MassUnit::Milligram);
    assert_eq!(mass.get_value(), 6.882);
}

#[test]
fn test_mass_set_value() {
    let mut mass = MassQuantity::new(6.882, MassUnit::Milligram);
    mass.set_value(8.92);
...
fn test_mass_to_string() {
    ...
    let mass_g_1 = MassQuantity::from_g(value_1);
    assert_eq!(mass_g_1.to_string(), "5g");
    let mass_mg_1 = MassQuantity::from_mg(value_1);
    assert_eq!(mass_mg_1.to_string(), "5mg");
    let mass_kg_1 = MassQuantity::from_kg(value_1);
    assert_eq!(mass_kg_1.to_string(), "5kg");
    let mass_ug_1 = MassQuantity::from_ug(value_1);
    assert_eq!(mass_ug_1.to_string(), "5ug");
    let mass_oz_1 = MassQuantity::from_oz(value_1);
    assert_eq!(mass_oz_1.to_string(), "5oz");

    let mass_g_2 = MassQuantity::from_g(value_2);
    assert_eq!(mass_g_2.to_string(), "8.642g");
    let mass_mg_2 = MassQuantity::from_mg(value_2);
    assert_eq!(mass_mg_2.to_string(), "8.642mg");
    let mass_kg_2 = MassQuantity::from_kg(value_2);
    assert_eq!(mass_kg_2.to_string(), "8.642kg");
    let mass_ug_2 = MassQuantity::from_ug(value_2);
    assert_eq!(mass_ug_2.to_string(), "8.642ug");
    let mass_oz_2 = MassQuantity::from_oz(value_2);
    assert_eq!(mass_oz_2.to_string(), "8.642oz");
}

#[test]
fn test_mass_add() {
    let mass_g_1 = MassQuantity::from_g(100f64);
    let mass_g_2 = MassQuantity::from_g(500f64);
    let mass_kg = MassQuantity::from_kg(2f64);

    let mass_g_1_plus_g_2 = MassQuantity::from_g(600f64);
...
fn test_mass_subtract() {
    let mass_g_1 = MassQuantity::from_g(6700f64);
    let mass_g_2 = MassQuantity::from_g(4700f64);
    let mass_kg = MassQuantity::from_kg(1.2f64);

    let mass_g_1_minus_g_2 = MassQuantity::from_g(2000f64);
...
fn test_energy_sum() {
    ...
    let mass_4 = MassQuantity::from_kg(20f64).to_oz();
    let mass_5 = MassQuantity::from_kg(130f64);
    let mass_total = MassQuantity::from_kg(250f64);
...
fn test_mass_partial_order() {
    let mass_g_1 = MassQuantity::from_g(6700f64);
    let mass_g_2 = MassQuantity::from_g(4700f64);
    let mass_kg = MassQuantity::from_kg(5.2f64);
